...
insert into author
values
('AID1','Samuel','Williams','samuel.williams@example.com','United States','+447589214360','PID2'),
('AID2','Rachel','Phillips','rachel.phillips@example.com','Canada','+447265437890','PID1'),
...
('AID5','Daniel ','Mitchell','daniel.mitchell@example.com','Australia','+443487652190','PID7'),
('AID6','Stella','Adams','stella.adams@example.com','France','+442390875164','PID9'),
('AID7','Isaac','Carter','isaac.carter@example.com','Germany','+447614098235','PID4'),
('AID8','Grace','Turner','grace.turner@example.com','Japan','+447201986735','PID2'),
('AID9','Benjamin','Hughes','benjamin.hughes@example.com','India','+447324679810','PID6'),
('AID10','Zoe','Parker','zoe.parker@example.com','China','+443769854120','PID5'),
('AID11','Ethan','Bennett','ethan.bennett@example.com','Italy','+448149267035','PID7'),
('AID12','Audrey','Lewis','audrey.lewis@example.com','Mexico','+447058397614','PID5'),
('AID13','Owen','Bennett','owen.bennett@example.com','Russia','+447134982705','PID10'),
('AID14','Mia','Stewart','mia.stewart@example.com','Canada','+447396708125','PID12'),
('AID15','Caleb','Wood','caleb.wood@example.com','Brazil','+447265410983','PID11'),
('AID16','Scarlett','Green','scarlett.green@example.com','United States','+447801694735','PID4'),
('AID17','Henry','Foster','henry.foster@example.com','United Kingdom','+447987430562','PID3');
...
('BID9', 'Secrets Unveiled', 'AID7','2021-07-18', 'GID13', 13.2, 'PID9', 'French', '978-4444444444444'),
('BID10', 'The Lost Chronicles', 'AID7','2020-08-28', 'GID8', 9.5, 'PID9', 'Italian', '978-5555555555555'),
('BID11', 'The Celestial Blade', 'AID2','2017-04-09', 'GID3', 12.75, 'PID12', 'Italian', '978-6666666666666'),
('BID12', 'Riddles of Time', 'AID9', '2019-01-25', 'GID3',10.99 , 'PID12', 'Italian', '978-7777777777777'),
...
('BID23', 'The Enchanted Whisper', 'AID12','2016-09-03', 'GID15', 15.50, 'PID2', 'French', '978-8202818287192'),
...
Values
('ODID1','OID1','BID1',2,'GID4'),
('ODID2','OID1','BID5',1,'GID3'),
('ODID3','OID1','BID6',1,'GID6'),
('ODID4','OID2','BID19',1,'GID15'),
('ODID5','OID3','BID5',1,'GID3'),
('ODID6','OID7','BID12',2,'GID3'),
('ODID7','OID3','BID1',1,'GID4'),
('ODID8','OID4','BID7',1,'GID1'),
('ODID9','OID4','BID8',2,'GID8'),
('ODID10','OID5','BID3',3,'GID4'),
('ODID11','OID6','BID18',1,'GID7'),
('ODID12','OID6','BID4',1,'GID2'),
('ODID13','OID8','BID9',2,'GID13'),
('ODID14','OID8','BID6',1,'GID6'),
('ODID15','OID9','BID11',2,'GID3'),
('ODID16','OID7','BID24',1,'GID14'),
('ODID17','OID12','BID5',2,'GID3'),
('ODID18','OID12','BID21',1,'GID6'),
('ODID19','OID9','BID15',1,'GID5'),
('ODID20','OID6','BID3',2,'GID4'),
('ODID21','OID5','BID16',1,'GID5'),
('ODID22','OID8','BID8',3,'GID8'),
('ODID23','OID9','BID14',1,'GID4'),
('ODID24','OID30','BID23',1,'GID15'),
('ODID25','OID29','BID12',4,'GID3'),
('ODID26','OID25','BID10',1,'GID8'),
('ODID27','OID27','BID20',2,'GID6'),
('ODID28','OID6','BID6',1,'GID6'),
('ODID29','OID5','BID17',2,'GID7'),
('ODID30','OID17','BID1',1,'GID4'),
('ODID31','OID17','BID22',1,'GID4'),
('ODID32','OID11','BID4',2,'GID2'),
('ODID33','OID9','BID14',1,'GID4'),
('ODID34','OID3','BID7',1,'GID1'),
('ODID35','OID1','BID25',2,'GID13'),
('ODID36','OID1','BID2',2,'GID5'),
('ODID37','OID6','BID19',5,'GID15'),
('ODID38','OID3','BID9',1,'GID13'),
('ODID39','OID4','BID13',1,'GID4'),
('ODID40','OID8','BID11',3,'GID3');


INSERT INTO membership
VALUES
("MID1","CID23","2023-08-12","2031-01-01","Standard Membership",120,5,3),
("MID2","CID6","2023-05-24","2031-01-01","Standard Membership",75,10,8),
("MID3","CID25","2023-12-03","2031-01-01","Standard Membership",200,8,4),
("MID4","CID30","2023-02-15","2031-01-01","Senior Citizen Membership",50,	3,2),
("MID5","CID12","2023-11-20","2031-01-01","Standard Membership",90,	10,10),
("MID6","CID4","2023-09-08","2031-01-01","Student Membership",150,7,6),
("MID7","CID5","2023-03-31","2031-01-01","Senior Citizen Membership",85,10, 10),
("MID8","CID2","2023-05-17","2031-01-01","Standard Membership",110,4,2),
("MID9","CID18","2023-08-12","2031-01-01","Standard Membership", 160,9,8),
("MID10","CID11","2023-05-24","2031-01-01","Senior Citizen Membership", 70,6,4),
("MID11","CID22","2023-12-03","2031-01-01", "Senior Citizen Membership",130,10,8),
("MID12","CID24","2023-02-15","2031-01-01","Standard Membership",80,2,1),
("MID13","CID28","2023-11-20","2031-01-01","Student Membership",95,10,8),
("MID14","CID3","2023-09-08","2031-01-01","Student Membership",140, 10,10),
("MID15","CID20","2023-03-31","2031-01-01","Standard Membership",105,1,1),
("MID16","CID30","2023-05-17","2031-01-01","Standard Membership",190,10,11),
("MID17","CID27","2023-08-12","2031-01-01","Student Membership",65,16,10),
("MID18","CID7","2023-05-24","2031-01-01","Senior Citizen Membership",170,10,10);
...
VALUES
('EID1','Jonathan','Anderson',123, 'Elm Street', 'Smithville', 'OH 12345','jonathananderson@example.com',44156678951,'Susan Johnson',44156688951,7,1),
('EID2','Katherine','Murphy',456, 'Oak Avenue', 'Willow_Creek', 'CA 98765','katherinemurphy@example.com', 44567313457,'David Smith',44587313457,12,0),
('EID3','Samuel','Evans',789,'Maple Lane', 'Oakville', 'L4X 2Z1','samuelevans@example.com', 44578784644,'Lisa Williams', 44578784444, 5, 1),
('EID4','Jessica', 'Turner',1010, 'Pine Road', 'Greenville', 'SC 29601','jessicaturner@example.com',44526384947,'Michael Davis',44509384947,10,1),
('EID5','Nicholas',	'Mitchell',	222, 'Birch Circle', 'Redwood', 'CA 94063', 'nicholasmitchell@example.com',44135778422,'Karen Brown',44165778422,3,0),
('EID6','Emma',	'Robinson',	333, 'Cedar Drive', 'Manchester', 'M1 1AB','emmarobinson@example.com',44143789492, 'Steven Wilson',44143786692,9,1),
('EID8','Lauren','Simmons',	555, 'Redwood Boulevard', 'Springfield', 'IL 62701','laurensimmons@example.com',44677233559, 'Thomas Harris',44677223559,8,0),
('EID9','Christopher','Cooper', 666, 'Willow Place', 'Portland', 'OR 97201','christophercooper@example.com',44857252748,'Laura Anderson',448575574,14,1);
